...
describe('PasswordResetController', () => {
    ...
    beforeEach(async () => {
      ...
      passwordResetController = module.get<PasswordResetController>(PasswordResetController);
    ...
    describe('requestPasswordReset', () => {
      it('should call generateResetToken with the correct email', async () => {
        ...
        expect(passwordResetService.generateResetToken).toHaveBeenCalledWith(email);
      });
    });
    ...
    describe('resetPassword', () => {
      it('should call resetPassword with the correct parameters', async () => {
        ...
        expect(passwordResetService.resetPassword).toHaveBeenCalledWith('Bearer token', newPassword);
      });
    });
  });