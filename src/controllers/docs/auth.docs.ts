    ...
    public static readonly LOGIN_RESPONSE = {
		...
		examples: {
			'application/json': {
				summary: 'Exemplo de login',
				value: {
					accessToken: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOjEzLCJlbWFpbCI6ImpvYW9AZXhhbXBsZS5jb20iLCJuYW1lIjoiSm_Do28gZGEgU2lsdmEiLCJyb2xlIjoidXNlciIsImlhdCI6MTcyMzU5MDYyMywiZXhwIjoxNzIzNjMzODIzfQ.xB_5sLnxASIePNj3gepIqEz8BAR7nJLqzJHy3YoHQUA"
				},
			},
		},
    }
